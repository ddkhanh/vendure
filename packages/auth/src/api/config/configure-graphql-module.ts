...
async function createGraphQLOptions(
     ...
     */
    async function buildSchemaForApi(apiType: 'authen'): Promise<GraphQLSchema> {
        ...
        const authStrategies = configService.authOptions.adminAuthenticationStrategy;
        ...
        schema = addGraphQLCustomFields(schema, customFields, apiType === 'authen');
